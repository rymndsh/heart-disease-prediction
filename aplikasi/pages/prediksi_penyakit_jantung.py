...
# Custom CSS for minimalist design & subtle visual elements
st.markdown("""
    <style>
    /* Import Inter font */
    ...
    /* Subtle background pattern (Heartbeat Pattern) */
    .stApp {
    ...
    hr {
        border: 0;
        height: 1px;
        background: linear-gradient(to right, transparent, #E94E77, transparent);
        margin: 20px 0;
    }
